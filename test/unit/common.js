...
export function test({MockHmac}) {
  describe('minimal-jwt', () => {
    ...
    beforeEach(async () => {
      ...
      payload = {location: 'accra'};
    });

    describe('JWT.sign', () => {
      it('should sign w/ a signFn that returns a base64url string',
        async () => {
    ...
    describe('JWT.verify', () => {
      it('should verify a valid JWT', async () => {
        ...
        res.payload.location.should.equal(payload.location);
      });
    });
